...
export function getAlloyItemsGet$Plain(http: HttpClient, rootUrl: string, params?: GetAlloyItemsGet$Plain$Params, context?: HttpContext): Observable<StrictHttpResponse<Array<ItemOutputDto>>> {
