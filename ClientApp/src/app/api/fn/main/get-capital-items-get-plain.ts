...
export function getCapitalItemsGet$Plain(http: HttpClient, rootUrl: string, params?: GetCapitalItemsGet$Plain$Params, context?: HttpContext): Observable<StrictHttpResponse<Array<Item>>> {
